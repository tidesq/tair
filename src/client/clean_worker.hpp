...
CleanWorker::CleanWorker(const char *server_addr, const char *group_name,
                         const int area, const int key_format, const char *name)
...
void CleanWorker::init(const char *server_addr, const char *group_name,
                       const int area, const int key_format, const char *name)
{
    _server_addr = NULL;
    _group_name = NULL;
...
char *CleanWorker::getName() { return _name; }
